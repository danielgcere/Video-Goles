...
class TextConstants {
    ...
    static getConstants() {
        return {
            LaunchRequestSpeakTextScreen: ['<say-as interpret-as="interjection">Hola</say-as>, bienvenido a Video Goles. Vamos a ponernos al día de la actualidad futbolística. ¿Qué le gustaría consultar?', '<say-as interpret-as="interjection">Hola</say-as>, bienvenido a Video Goles. Vamos a ponernos al día de la actualidad futbolística. ¿Qué le gustaría consultar?'],
            LaunchRequestRepromptTextScreen: ['<say-as interpret-as="interjection">Hola</say-as>, bienvenido a Video Goles. Vamos a ponernos al día de la actualidad futbolística. ¿Qué le gustaría consultar?', '<say-as interpret-as="interjection">Hola</say-as>, bienvenido a Video Goles. Vamos a ponernos al día de la actualidad futbolística. ¿Qué le gustaría consultar?'],
            LaunchRequestSpeakText: ['<say-as interpret-as="interjection">Hola</say-as>, bienvenido a Video Goles. Vamos a ponernos al día de la actualidad futbolística. ¿Qué le gustaría consultar?', '<say-as interpret-as="interjection">Hola</say-as>, bienvenido a Video Goles. Vamos a ponernos al día de la actualidad futbolística. ¿Qué le gustaría consultar?'],
            LaunchRequestRepromptText: ['<say-as interpret-as="interjection">Hola</say-as>, bienvenido a Video Goles. Vamos a ponernos al día de la actualidad futbolística. ¿Qué le gustaría consultar?', '<say-as interpret-as="interjection">Hola</say-as>, bienvenido a Video Goles. Vamos a ponernos al día de la actualidad futbolística. ¿Qué le gustaría consultar?'],
